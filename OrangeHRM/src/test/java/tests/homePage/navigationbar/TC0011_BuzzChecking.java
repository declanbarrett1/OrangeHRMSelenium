...
public class TC0011_BuzzChecking {
    WebDriver driver;
    Logger logger;
    HomePage homePage;
    ...
    public void testingAdminLink(){
        ...
        if(url.equals("https://opensource-demo.orangehrmlive.com/index.php/buzz/viewBuzz")){
            logger.info("Test Passed - On correct URL");
        }
        else{
            logger.info("Test Failed - PIM Link not correct or URL has changed");
        }
        Assert.assertEquals("https://opensource-demo.orangehrmlive.com/index.php/buzz/viewBuzz", url);
    }
