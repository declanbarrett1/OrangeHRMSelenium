...
public class TC006_MyInfoChecking {
    WebDriver driver;
    Logger logger;
    HomePage homePage;
    ...
    public void testingAdminLink(){
        ...
        if(url.equals("https://opensource-demo.orangehrmlive.com/index.php/pim/viewMyDetails")){
            logger.info("Test Passed - On correct URL");
        }
        else{
            logger.info("Test Failed - PIM Link not correct or URL has changed");
        }
        Assert.assertEquals("https://opensource-demo.orangehrmlive.com/index.php/pim/viewMyDetails", url);
    }
