...
public class TC0010_MaintenanceChecking {
    WebDriver driver;
    Logger logger;
    HomePage homePage;
    ...
    public void testingAdminLink(){
        ...
        if(url.equals("https://opensource-demo.orangehrmlive.com/index.php/maintenance/purgeEmployee")){
            logger.info("Test Passed - On correct URL");
        }
        else{
            logger.info("Test Failed - PIM Link not correct or URL has changed");
        }
        Assert.assertEquals("https://opensource-demo.orangehrmlive.com/index.php/maintenance/purgeEmployee", url);
    }
