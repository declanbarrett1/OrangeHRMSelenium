...
public class TC007_PerformanceChecking {
    ...
    public void testingAdminLink(){
        ...
        if(url.equals("https://opensource-demo.orangehrmlive.com/index.php/time/viewEmployeeTimesheet")){
            logger.info("Test Passed - On correct URL");
        }
        else{
            logger.info("Test Failed - PIM Link not correct or URL has changed");
        }
        Assert.assertEquals("https://opensource-demo.orangehrmlive.com/index.php/time/viewEmployeeTimesheet", url);
    }
